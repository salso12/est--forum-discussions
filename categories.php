...
<html>
    <head>
        <title> ESTSB forum </title>
        <link type="text/css" rel="stylesheet" href="css/style.css">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link type="text/css" rel="stylesheet" href="css/material.css">
        <link type="text/css" rel="stylesheet" href="fonts/font.css">
        <link rel="icon" href="images/GITAMLOGO.jpg" >
        <!-- Sripts -->
                ...
                <center>
                    <a id="db" href="#box4">
                        <div id="database" class="img">
                            <div id="p" title="Open">database </div>
                        </div>
                    </a>
                    <a id="pqt" href="#box5">
                        <div id="prob" class="img">
                            <div id="p" title="Open">Probability &amp; Queuing</div>
                        </div>
                    </a>
                    <a id="se" href="#box6">
                        <div id="soft" class="img">
                            <div id="p" title="Open">softwer Engineering</div>
                        </div>
                    </a>
                </center>
            </div>
